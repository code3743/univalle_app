...
class PeriodGradesSection extends StatelessWidget {
  const PeriodGradesSection({super.key, required this.grades, required this.accent});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _HeaderStat(value: '${grades.credits}', label: StudentGradesStrings.creditsLabel),
                const _HeaderDivider(),
                _HeaderStat(
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) => SubjectTile(subject: grades.subjects[index]),
          ),
        ],
      ),
    );
