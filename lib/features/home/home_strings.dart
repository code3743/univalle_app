abstract final class HomeStrings {
  static const universityName = 'Universidad\ndel Valle';
  static const notifications = 'Notificaciones';
  static const greeting = 'Hola,';
  static const tagline = 'Tu camino académico, en un solo lugar.';
  static const currentSemesterLabel = 'Semestre actual:';
  static const currentSemesterUnknown = '—';
  static const logout = 'Cerrar sesión';
  static const averageLabel = 'Promedio acumulado';
